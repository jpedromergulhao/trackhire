...
export default function Home() {
  ...
  const handleClick = () => {
    if (user) {
      ...
      setAlert({
        type: "error",
        message: "To access the applications area, you must be logged in.",
      });
    }
  }
  ...
  return (
    <section className="flex flex-col items-center space-y-10 lg:flex-row lg:space-y-0 lg:space-x-20">
      <div className="space-y-6">
        ...
        <button
          onClick={handleClick}
          className="bg-cyan-950 hover:bg-cyan-800 text-white transition-all duration-300 cursor-pointer 
